...
public class ScenarioManager {
    ...
    public static void apply(int period) {
        if (Configuration.SCENARIO != Configuration.DISABLED && Configuration.SCENARIO_START == period) {
            Scenario sc = ScenarioFactory.get(Configuration.SCENARIO);
            Console.info("ScenarioManager: Applying Scenario " + Configuration.SCENARIO + " at period " + Configuration.SCENARIO_START + "  [" + sc + "]");
            sc.apply();
        }
    }
}
